...
`ol.vips` uses https://github.com/babashka/ffi[babashka/ffi] and requires Java
25{plus} for FFI/FFM (Project Panama).
...
{:deps {com.outskirtslabs/vips {:mvn/version "0.0.1"}
        ...
        com.outskirtslabs/vips-native-linux-x86-64-gnu {:mvn/version "1.3.2-1"}}}
----
...
The native companion jars bundle libvips 8.18.3 from `sharp-libvips` 1.3.2.
