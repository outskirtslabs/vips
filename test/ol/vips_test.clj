...
(deftest metadata-api
  ...
  (testing "assoc/update/dissoc field operate immutably on image metadata"
    (with-open [img         (v/from-file puppies-path)
                ...
                blob-added  (v/assoc-field str-added "custom-blob" (byte-array [1 2 3 4]) {:type :blob})
                arr-added   (v/assoc-field blob-added "custom-delay" [10 20 30] {:type :array-int})
      ...
      (is (= [1 2 3 4] (vec (v/field blob-added "custom-blob"))))
