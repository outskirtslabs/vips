...
(def registry
  {:abs                   {:id :abs, :operation-name "abs", :description "absolute value of an image", :required-inputs [{:name "in", :blurb "Input image", :type {:kind :image, :label "image"}}], :optional-inputs [], :outputs [{:name "out", :blurb "Output image", :type {:kind :image, :label "image"}}]}
   ...
   :affine                {:id :affine, :operation-name "affine", :description "affine transform of an image", :required-inputs [{:name "in", :blurb "Input image argument", :type {:kind :image, :label "image"}} {:name "matrix", :blurb "Transformation matrix", :type {:kind :float-seq, :label "seqable of number"}}], :optional-inputs [{:name "odx", :blurb "Horizontal output displacement", :type {:kind :float, :label "float"}} {:name "ody", :blurb "Vertical output displacement", :type {:kind :float, :label "float"}} {:name "idx", :blurb "Horizontal input displacement", :type {:kind :float, :label "float"}} {:name "idy", :blurb "Vertical input displacement", :type {:kind :float, :label "float"}} {:name "background", :blurb "Background value", :type {:kind :float-seq, :label "seqable of number"}} {:name "premultiplied", :blurb "Images have premultiplied alpha", :type {:kind :boolean, :label "boolean"}} {:name "extend", :blurb "How to generate the extra pixels", :type {:kind :enum, :label "keyword", :enum-id :extend, :reference "ol.vips.enums/extend"}}], :outputs [{:name "out", :blurb "Output image", :type {:kind :image, :label "image"}}]}
   :arrayjoin             {:id :arrayjoin, :operation-name "arrayjoin", :description "join an array of images", :required-inputs [{:name "in", :blurb "Array of input images", :type {:kind :image-seq, :label "seqable of image"}}], :optional-inputs [{:name "across", :blurb "Number of images across grid", :type {:kind :integer, :label "integer"}} {:name "shim", :blurb "Pixels between images", :type {:kind :integer, :label "integer"}} {:name "background", :blurb "Colour for new pixels", :type {:kind :float-seq, :label "seqable of number"}} {:name "halign", :blurb "Align on the left, centre or right", :type {:kind :enum, :label "keyword", :enum-id :align, :reference "ol.vips.enums/align"}} {:name "valign", :blurb "Align on the top, centre or bottom", :type {:kind :enum, :label "keyword", :enum-id :align, :reference "ol.vips.enums/align"}} {:name "hspacing", :blurb "Horizontal spacing between images", :type {:kind :integer, :label "integer"}} {:name "vspacing", :blurb "Vertical spacing between images", :type {:kind :integer, :label "integer"}}], :outputs [{:name "out", :blurb "Output image", :type {:kind :image, :label "image"}}]}
   ...
   :bandjoin-const        {:id :bandjoin-const, :operation-name "bandjoin_const", :description "append a constant band to an image", :required-inputs [{:name "in", :blurb "Input image", :type {:kind :image, :label "image"}} {:name "c", :blurb "Array of constants to add", :type {:kind :float-seq, :label "seqable of number"}}], :optional-inputs [], :outputs [{:name "out", :blurb "Output image", :type {:kind :image, :label "image"}}]}
   ...
   :boolean-const         {:id :boolean-const, :operation-name "boolean_const", :description "boolean operations against a constant", :required-inputs [{:name "in", :blurb "Input image", :type {:kind :image, :label "image"}} {:name "boolean", :blurb "Boolean to perform", :type {:kind :enum, :label "keyword", :enum-id :operation-boolean, :reference "ol.vips.enums/operation-boolean"}} {:name "c", :blurb "Array of constants", :type {:kind :float-seq, :label "seqable of number"}}], :optional-inputs [], :outputs [{:name "out", :blurb "Output image", :type {:kind :image, :label "image"}}]}
   ...
   :draw-circle           {:id :draw-circle, :operation-name "draw_circle", :description "draw a circle on an image", :required-inputs [{:name "image", :blurb "Image to draw on", :type {:kind :image, :label "image"}} {:name "ink", :blurb "Color for pixels", :type {:kind :float-seq, :label "seqable of number"}} {:name "cx", :blurb "Centre of draw_circle", :type {:kind :integer, :label "integer"}} {:name "cy", :blurb "Centre of draw_circle", :type {:kind :integer, :label "integer"}} {:name "radius", :blurb "Radius in pixels", :type {:kind :integer, :label "integer"}}], :optional-inputs [{:name "fill", :blurb "Draw a solid object", :type {:kind :boolean, :label "boolean"}}], :outputs []}
   :draw-flood            {:id :draw-flood, :operation-name "draw_flood", :description "flood-fill an area", :required-inputs [{:name "image", :blurb "Image to draw on", :type {:kind :image, :label "image"}} {:name "ink", :blurb "Color for pixels", :type {:kind :float-seq, :label "seqable of number"}} {:name "x", :blurb "DrawFlood start point", :type {:kind :integer, :label "integer"}} {:name "y", :blurb "DrawFlood start point", :type {:kind :integer, :label "integer"}}], :optional-inputs [{:name "test", :blurb "Test pixels in this image", :type {:kind :image, :label "image"}} {:name "equal", :blurb "DrawFlood while equal to edge", :type {:kind :boolean, :label "boolean"}}], :outputs [{:name "left", :blurb "Left edge of modified area", :type {:kind :integer, :label "integer"}} {:name "top", :blurb "Top edge of modified area", :type {:kind :integer, :label "integer"}} {:name "width", :blurb "Width of modified area", :type {:kind :integer, :label "integer"}} {:name "height", :blurb "Height of modified area", :type {:kind :integer, :label "integer"}}]}
   ...
   :draw-line             {:id :draw-line, :operation-name "draw_line", :description "draw a line on an image", :required-inputs [{:name "image", :blurb "Image to draw on", :type {:kind :image, :label "image"}} {:name "ink", :blurb "Color for pixels", :type {:kind :float-seq, :label "seqable of number"}} {:name "x1", :blurb "Start of draw_line", :type {:kind :integer, :label "integer"}} {:name "y1", :blurb "Start of draw_line", :type {:kind :integer, :label "integer"}} {:name "x2", :blurb "End of draw_line", :type {:kind :integer, :label "integer"}} {:name "y2", :blurb "End of draw_line", :type {:kind :integer, :label "integer"}}], :optional-inputs [], :outputs []}
   :draw-mask             {:id :draw-mask, :operation-name "draw_mask", :description "draw a mask on an image", :required-inputs [{:name "image", :blurb "Image to draw on", :type {:kind :image, :label "image"}} {:name "ink", :blurb "Color for pixels", :type {:kind :float-seq, :label "seqable of number"}} {:name "mask", :blurb "Mask of pixels to draw", :type {:kind :image, :label "image"}} {:name "x", :blurb "Draw mask here", :type {:kind :integer, :label "integer"}} {:name "y", :blurb "Draw mask here", :type {:kind :integer, :label "integer"}}], :optional-inputs [], :outputs []}
   :draw-rect             {:id :draw-rect, :operation-name "draw_rect", :description "paint a rectangle on an image", :required-inputs [{:name "image", :blurb "Image to draw on", :type {:kind :image, :label "image"}} {:name "ink", :blurb "Color for pixels", :type {:kind :float-seq, :label "seqable of number"}} {:name "left", :blurb "Rect to fill", :type {:kind :integer, :label "integer"}} {:name "top", :blurb "Rect to fill", :type {:kind :integer, :label "integer"}} {:name "width", :blurb "Rect to fill", :type {:kind :integer, :label "integer"}} {:name "height", :blurb "Rect to fill", :type {:kind :integer, :label "integer"}}], :optional-inputs [{:name "fill", :blurb "Draw a solid object", :type {:kind :boolean, :label "boolean"}}], :outputs []}
   ...
   :find-trim             {:id :find-trim, :operation-name "find_trim", :description "search an image for non-edge areas", :required-inputs [{:name "in", :blurb "Image to find_trim", :type {:kind :image, :label "image"}}], :optional-inputs [{:name "threshold", :blurb "Object threshold", :type {:kind :float, :label "float"}} {:name "background", :blurb "Color for background pixels", :type {:kind :float-seq, :label "seqable of number"}} {:name "line-art", :blurb "Enable line art mode", :type {:kind :boolean, :label "boolean"}}], :outputs [{:name "left", :blurb "Left edge of image", :type {:kind :integer, :label "integer"}} {:name "top", :blurb "Top edge of extract area", :type {:kind :integer, :label "integer"}} {:name "width", :blurb "Width of extract area", :type {:kind :integer, :label "integer"}} {:name "height", :blurb "Height of extract area", :type {:kind :integer, :label "integer"}}]}
   :flatten               {:id :flatten, :operation-name "flatten", :description "flatten alpha out of an image", :required-inputs [{:name "in", :blurb "Input image", :type {:kind :image, :label "image"}}], :optional-inputs [{:name "background", :blurb "Background value", :type {:kind :float-seq, :label "seqable of number"}} {:name "max-alpha", :blurb "Maximum value of alpha channel", :type {:kind :float, :label "float"}}], :outputs [{:name "out", :blurb "Output image", :type {:kind :image, :label "image"}}]}
   ...
   :lab2-xyz              {:id :lab2-xyz, :operation-name "Lab2XYZ", :description "transform CIELAB to XYZ", :required-inputs [{:name "in", :blurb "Input image", :type {:kind :image, :label "image"}}], :optional-inputs [{:name "temp", :blurb "Color temperature", :type {:kind :float-seq, :label "seqable of number"}}], :outputs [{:name "out", :blurb "Output image", :type {:kind :image, :label "image"}}]}
   ...
   :linear                {:id :linear, :operation-name "linear", :description "calculate (a * in + b)", :required-inputs [{:name "in", :blurb "Input image", :type {:kind :image, :label "image"}} {:name "a", :blurb "Multiply by this", :type {:kind :float-seq, :label "seqable of number"}} {:name "b", :blurb "Add this", :type {:kind :float-seq, :label "seqable of number"}}], :optional-inputs [{:name "uchar", :blurb "Output should be uchar", :type {:kind :boolean, :label "boolean"}}], :outputs [{:name "out", :blurb "Output image", :type {:kind :image, :label "image"}}]}
   ...
   :mapim                 {:id :mapim, :operation-name "mapim", :description "resample with a map image", :required-inputs [{:name "in", :blurb "Input image argument", :type {:kind :image, :label "image"}} {:name "index", :blurb "Index pixels with this", :type {:kind :image, :label "image"}}], :optional-inputs [{:name "background", :blurb "Background value", :type {:kind :float-seq, :label "seqable of number"}} {:name "premultiplied", :blurb "Images have premultiplied alpha", :type {:kind :boolean, :label "boolean"}} {:name "extend", :blurb "How to generate the extra pixels", :type {:kind :enum, :label "keyword", :enum-id :extend, :reference "ol.vips.enums/extend"}}], :outputs [{:name "out", :blurb "Output image", :type {:kind :image, :label "image"}}]}
   ...
   :math2-const           {:id :math2-const, :operation-name "math2_const", :description "binary math operations with a constant", :required-inputs [{:name "in", :blurb "Input image", :type {:kind :image, :label "image"}} {:name "math2", :blurb "Math to perform", :type {:kind :enum, :label "keyword", :enum-id :operation-math2, :reference "ol.vips.enums/operation-math2"}} {:name "c", :blurb "Array of constants", :type {:kind :float-seq, :label "seqable of number"}}], :optional-inputs [], :outputs [{:name "out", :blurb "Output image", :type {:kind :image, :label "image"}}]}
   ...
   :relational-const      {:id :relational-const, :operation-name "relational_const", :description "relational operations against a constant", :required-inputs [{:name "in", :blurb "Input image", :type {:kind :image, :label "image"}} {:name "relational", :blurb "Relational to perform", :type {:kind :enum, :label "keyword", :enum-id :operation-relational, :reference "ol.vips.enums/operation-relational"}} {:name "c", :blurb "Array of constants", :type {:kind :float-seq, :label "seqable of number"}}], :optional-inputs [], :outputs [{:name "out", :blurb "Output image", :type {:kind :image, :label "image"}}]}
   ...
   :remainder-const       {:id :remainder-const, :operation-name "remainder_const", :description "remainder after integer division of an image and a constant", :required-inputs [{:name "in", :blurb "Input image", :type {:kind :image, :label "image"}} {:name "c", :blurb "Array of constants", :type {:kind :float-seq, :label "seqable of number"}}], :optional-inputs [], :outputs [{:name "out", :blurb "Output image", :type {:kind :image, :label "image"}}]}
   ...
   :rotate                {:id :rotate, :operation-name "rotate", :description "rotate an image by a number of degrees", :required-inputs [{:name "in", :blurb "Input image argument", :type {:kind :image, :label "image"}} {:name "angle", :blurb "Rotate clockwise by this many degrees", :type {:kind :float, :label "float"}}], :optional-inputs [{:name "background", :blurb "Background value", :type {:kind :float-seq, :label "seqable of number"}} {:name "odx", :blurb "Horizontal output displacement", :type {:kind :float, :label "float"}} {:name "ody", :blurb "Vertical output displacement", :type {:kind :float, :label "float"}} {:name "idx", :blurb "Horizontal input displacement", :type {:kind :float, :label "float"}} {:name "idy", :blurb "Vertical input displacement", :type {:kind :float, :label "float"}}], :outputs [{:name "out", :blurb "Output image", :type {:kind :image, :label "image"}}]}
   ...
   :sdf                   {:id :sdf, :operation-name "sdf", :description "create an SDF image", :required-inputs [{:name "width", :blurb "Image width in pixels", :type {:kind :integer, :label "integer"}} {:name "height", :blurb "Image height in pixels", :type {:kind :integer, :label "integer"}} {:name "shape", :blurb "SDF shape to create", :type {:kind :enum, :label "keyword", :enum-id :sdf-shape, :reference "ol.vips.enums/sdf-shape"}}], :optional-inputs [{:name "r", :blurb "Radius", :type {:kind :float, :label "float"}} {:name "a", :blurb "Point a", :type {:kind :float-seq, :label "seqable of number"}} {:name "b", :blurb "Point b", :type {:kind :float-seq, :label "seqable of number"}} {:name "corners", :blurb "Corner radii", :type {:kind :float-seq, :label "seqable of number"}}], :outputs [{:name "out", :blurb "Output image", :type {:kind :image, :label "image"}}]}
   ...
   :similarity            {:id :similarity, :operation-name "similarity", :description "similarity transform of an image", :required-inputs [{:name "in", :blurb "Input image argument", :type {:kind :image, :label "image"}}], :optional-inputs [{:name "scale", :blurb "Scale by this factor", :type {:kind :float, :label "float"}} {:name "angle", :blurb "Rotate clockwise by this many degrees", :type {:kind :float, :label "float"}} {:name "background", :blurb "Background value", :type {:kind :float-seq, :label "seqable of number"}} {:name "odx", :blurb "Horizontal output displacement", :type {:kind :float, :label "float"}} {:name "ody", :blurb "Vertical output displacement", :type {:kind :float, :label "float"}} {:name "idx", :blurb "Horizontal input displacement", :type {:kind :float, :label "float"}} {:name "idy", :blurb "Vertical input displacement", :type {:kind :float, :label "float"}}], :outputs [{:name "out", :blurb "Output image", :type {:kind :image, :label "image"}}]}
